...
static const char UNUSED *bitcoin_strings[] = {
    QT_TRANSLATE_NOOP("sugar-point", "Bitcoin SGRPT"),
    QT_TRANSLATE_NOOP("sugar-point", "The %s developers"),
    QT_TRANSLATE_NOOP("sugar-point",
                      ""
    ...
    QT_TRANSLATE_NOOP("sugar-point", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("sugar-point", "%s is set very high!"),
    QT_TRANSLATE_NOOP("sugar-point", "(default: %s)"),
    QT_TRANSLATE_NOOP("sugar-point", "(default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("sugar-point", "<category> can be:"),
    QT_TRANSLATE_NOOP("sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Append comment to the user agent string"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Attempt to recover private keys from a corrupt wallet on startup"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Automatically create Tor hidden service (default: %d)"),
    QT_TRANSLATE_NOOP("sugar-point", "Block creation options:"),
    QT_TRANSLATE_NOOP("sugar-point", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("sugar-point", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("sugar-point", "Cannot write default address"),
    QT_TRANSLATE_NOOP("sugar-point", "Chain selection options:"),
    QT_TRANSLATE_NOOP("sugar-point", "Change index out of range"),
    QT_TRANSLATE_NOOP("sugar-point", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("sugar-point", "Connection options:"),
    QT_TRANSLATE_NOOP("sugar-point", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("sugar-point", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("sugar-point", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("sugar-point", "Done loading"),
    QT_TRANSLATE_NOOP("sugar-point", "Enable publish hash block in <address>"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Enable publish hash transaction in <address>"),
    QT_TRANSLATE_NOOP("sugar-point", "Enable publish raw block in <address>"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Enable publish raw transaction in <address>"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Enable transaction replacement in the memory pool (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Error initializing block database"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("sugar-point", "Error loading %s"),
    QT_TRANSLATE_NOOP("sugar-point", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("sugar-point", "Error loading %s: You can't disable HD "
                                     "on a already existing HD wallet"),
    QT_TRANSLATE_NOOP("sugar-point", "Error loading block database"),
    QT_TRANSLATE_NOOP("sugar-point", "Error opening block database"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("sugar-point", "Error"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("sugar-point", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Importing..."),
    QT_TRANSLATE_NOOP(
        "sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Information"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("sugar-point", "Insufficient funds"),
    QT_TRANSLATE_NOOP("sugar-point", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("sugar-point", "Invalid -proxy address: '%s'"),
    QT_TRANSLATE_NOOP("sugar-point", "Invalid amount for -%s=<amount>: '%s'"),
    QT_TRANSLATE_NOOP("sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Listen for JSON-RPC connections on "
                                     "<port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Listen for connections on <port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Loading addresses..."),
    QT_TRANSLATE_NOOP("sugar-point", "Loading banlist..."),
    QT_TRANSLATE_NOOP("sugar-point", "Loading block index..."),
    QT_TRANSLATE_NOOP("sugar-point", "Loading wallet..."),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Location of the auth cookie (default: data dir)"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Maintain at most <n> connections to peers (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Make the wallet broadcast transactions"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Node relay options:"),
    QT_TRANSLATE_NOOP("sugar-point", "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("sugar-point", "Options:"),
    QT_TRANSLATE_NOOP("sugar-point", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("sugar-point", "Print version and exit"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("sugar-point", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("sugar-point", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("sugar-point", "Reducing -maxconnections from %d to %d, "
                                     "because of system limitations."),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("sugar-point", "Rescanning..."),
    QT_TRANSLATE_NOOP("sugar-point", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Set key pool size to <n> (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("sugar-point", "Specify data directory"),
    QT_TRANSLATE_NOOP("sugar-point", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("sugar-point", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Starting network threads..."),
    QT_TRANSLATE_NOOP("sugar-point", "The source code is available from %s."),
    QT_TRANSLATE_NOOP("sugar-point",
                      "The transaction amount is too small to pay the fee"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "The wallet will avoid paying less than the minimum relay fee."),
    QT_TRANSLATE_NOOP("sugar-point", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("sugar-point",
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Transaction too large for fee policy"),
    QT_TRANSLATE_NOOP("sugar-point", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "sugar-point",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("sugar-point", "Unable to bind to %s on this computer. "
    ...
    QT_TRANSLATE_NOOP("sugar-point", "Use the test chain"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("sugar-point", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("sugar-point", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("sugar-point", "Verifying wallet..."),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("sugar-point", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("sugar-point", "Wallet options:"),
    QT_TRANSLATE_NOOP("sugar-point", "Warning"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Warning: unknown new rules activated (versionbit %i)"),
    QT_TRANSLATE_NOOP("sugar-point",
                      "Whether to operate in a blocks only mode (default: %u)"),
    QT_TRANSLATE_NOOP("sugar-point", "Zapping all transactions from wallet..."),
    QT_TRANSLATE_NOOP("sugar-point", "ZeroMQ notification options:"),
};
